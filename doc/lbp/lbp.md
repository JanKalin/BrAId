# FNavodila za uporabo LBP (Label Braid Photos)
...
- `axle_groups` vsebuje skupine osi vozila. Če podatka ni, ali pa se vrednost ujema z originalno vrednostjo, je originalna vrednost OK.
